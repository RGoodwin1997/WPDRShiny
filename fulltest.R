  ...
  output$text <- renderText({
    if (input$adj=="None"){
      ...
      if (input$adj=="Standardized Incidence Ratio"){
        "The standardized incidence ratio (SIR) is a method of adjusting for tract population by calculating a ratio of the observed count of arrests to the expected counts of arrests. T"
      } else
